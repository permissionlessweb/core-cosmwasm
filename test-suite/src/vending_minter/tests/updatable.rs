...
// use cw721::msg::{Cw721QueryMsg, NftInfoResponse, TokensResponse};
// use cw721_base::Extension;
// use cw_multi_test::Executor;
// use cw721_updatable::msg::ExecuteMsg as cw721UpdatableExecMsg;
...
//     templates::vending_minter_with_cw721_updatable,
// };

// #[test]
// fn update_token_metadata() {
//     // create updatable collection and minter
//     let vt = vending_minter_with_cw721_updatable(10);
...
//     let msg = cw721UpdatableExecMsg::<Empty, Empty>::UpdateTokenMetadata {
