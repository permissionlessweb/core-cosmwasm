...
use cw721::msg::{Cw721QueryMsg, TokensResponse};
...
fn earlybird_mint_count_query() {
    ...
    let tokens_msg = Cw721QueryMsg::<Empty, Empty, Empty>::Tokens {
    ...
    let transfer_msg: Cw721ExecuteMsg = Cw721ExecuteMsg::TransferNft {
